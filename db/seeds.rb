...
Flyer.create!(user_name:  'Cat', password: 'password', first_name: "Cat", last_name: "B", occupation: "Senior DEV", description: "Let's Do This, sh*t!", img_url: "https://avatars0.githubusercontent.com/u/40864734?s=400&v=4", airport_id: Airport.second.id)
