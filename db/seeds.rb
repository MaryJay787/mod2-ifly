...
f = Flyer.create!(user_name: 'Chris', password: 'password', first_name: "Christopher", last_name: "Swofford", occupation: "Software Engineer", description: "I love Marlin!", img_url: "https://avatars0.githubusercontent.com/u/47920045?s=460&v=4", airport_id: Airport.second.id)
e = Flyer.create!(user_name: 'Zach', password: 'password', first_name: "Zach", last_name: "Parker", occupation: " Senior DEV", description: "I love the Mountains!", img_url: "https://avatars0.githubusercontent.com/u/50035946?s=460&v=4", airport_id: Airport.second.id)
d = Flyer.create!(user_name:  'Cat', password: 'password', first_name: "Cat", last_name: "B", occupation: "Senior DEV", description: "I get sh*t Done", img_url: "https://avatars0.githubusercontent.com/u/40864734?s=400&v=4", airport_id: Airport.second.id)
c = Flyer.create!(user_name:  'Rere', password: 'password', first_name: "Reina", last_name: "Ewing", occupation: "Mom", description: "I Got you. I will take care of it!", img_url: "https://avatars1.githubusercontent.com/u/48366278?s=400&v=4", airport_id: Airport.second.id)
b = Flyer.create!(user_name:  'Con', password: 'password', first_name: "Conrad", last_name: "Casper", occupation: "Full Stack Web Developer", description: "I'm from Texas, where everthing is big!", img_url: "https://media.licdn.com/dms/image/C4E03AQHqE1pkFQh6UA/profile-displayphoto-shrink_800_800/0?e=1568246400&v=beta&t=vyicZ0oLqG-cZFMpP4KqKMgi_QfP5p8QDLAN_DBS29E", airport_id: Airport.second.id)
a = Flyer.create!(user_name:  'Kal', password: 'password', first_name: "Christopher", last_name: "Kalfas", occupation: "The Best Dev", description: "Have you heard the Kalfinator?", img_url: "https://media.licdn.com/dms/image/C4D03AQElOPlYWNrMiw/profile-displayphoto-shrink_800_800/0?e=1568246400&v=beta&t=6SZLND1zUS2JORRfqg2fq_cqPqUQ37JJdAaDuREyq2k", airport_id: Airport.second.id)
...
Conversation.create(sender_id: f.id, recipient_id: a.id)
Conversation.create(sender_id: e.id, recipient_id: b.id)
Conversation.create(sender_id: d.id, recipient_id: c.id)
Conversation.create(sender_id: c.id, recipient_id: d.id)
Conversation.create(sender_id: b.id, recipient_id: e.id)
Conversation.create(sender_id: a.id, recipient_id: f.id)
